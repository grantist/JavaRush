...
public class Solution {
    ...
    public static void main(String...args) throws IOException {
        try (
                ...
                //вернет ссылку на загрузчик, загрузивший этот класс, т.е. загрузивший тот самый байт-код,
                // который выполняет данный вызов. Class.getResourceAsStream обращаются к соответствующим
                // методам текущего загрузчика, загрузившего данный класс.
        ) {
